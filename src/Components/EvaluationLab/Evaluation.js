                ...
                <section className="section3_main ">
                    <div className="section3_innerDiv ">
                        ...
                        <div className="active_stageButton">
                            <button className={`active_stage2 ${active == "2" && "activeBtn"}`} onClick={() => setActive("2")}>Stage 2</button>
                            <button className={`active_stage22 ${active == "3" && "activeBtn"}`} onClick={() => setActive("3")}>Stage 3</button>
                            <button className={`active_stage22 ${active == "4" && "activeBtn"}`} onClick={() => setActive("4")}>Stage 4</button>
                        </div>
                        {active === "2" &&
                                ...
                                <div className="box_textDiv">
                                    <div className="button_divMa">
                                        ...
                                        <div className="both_button">
                                            <div className="buttons_container">
                                                <button> CONNECT WALLET <span> <IoIosArrowForward /> </span> </button>
                                            </div>

                                            <div className="buttons_container">
                                                <button> BUY MONKEY <span> <IoIosArrowForward /> </span> </button>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div className="first_round_image">
                                            ...
                                            <div> <img className="ques_image" src={question} />
                                                <div className="button_container">
                                                    <button> Evolve <span> <IoIosArrowForward /> </span> </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {active === "3" &&
                            <div className="box_mainDiv">
                                <div className="box_textDiv">
                                    ...
                                    <div className="first_textDiv">
                                        <p className="order_text">The <span className="gal">Alien Gorilla</span>is the <span className="gal">KEY</span> o winning against the alien invader and winning The Inter-Galactic War, you’ll have to sacrifice
                                            <span className="gal">3 Galactic Gorillas</span> in order to achieve such a strong being and protect the species from extinction.
                                        </p>
                                        <p className="note_text"><span className="gal">NOTE:</span> By clicking “<span className="gal">Evolve</span>”, the <span>Galactic Gorillas</span> you’ve chosen will be sent to a Solana black hole wallet and disappear forever, however,
                                            black hole wallet and disappear forever, however,
                                            <span>EACH EVOLUTION</span> will make you more money in the <span className="gal">Mooning Monkey Game.</span></p>
                                    </div>
                                ...
                                <div className="box_textDiv">
                                    ...
                                    <div className="first_textDiv">
                                        <p className="order_text">
                                            Although <span className="gal">The Alien Gorilla</span> is extremely powerful, it is still bound by the shackles of mortality… as well as an
                                            unsettling look that’s not easy on the eye, in order to guarantee the survival of the <span className="gal">Mooning Monkey’s Species AND</span> make sure they do so with style… You’ll need to sacrifice<span className="gal"> 2 Of Your Alien Gorillas</span> to make <span className="gal">
                                                1 Eternal Yeti</span> that will live forever on the Blockchain and earn the highest possible levels of daily game rewards.
                                        </p>
                                        <p className="note_text"><span className="gal">NOTE:</span> By clicking “<span className="gal">Evolve</span>”, the <span>Alien Gorillas</span> you’ve chosen will be sent to a Solana black hole wallet and disappear forever, however,
                                            black hole wallet and disappear forever, however,
                                            <span className="gal">EACH EVOLUTION</span> will make you more money in the <span className="gal">Mooning Monkey Game.</span></p>
                                    </div>
