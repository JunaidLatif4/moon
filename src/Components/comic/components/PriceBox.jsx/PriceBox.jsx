  ...
  return (
    <div className="price__box">
      ...
      <div className="price__box_inputbox">
        <input
          type="text"
          className="price__box_input"
          //   placeholder="100,000 TAK max"
        />
        <div className="placeholder-text">100,000 TAK max</div>
      </div>
      <div className="price__box_total">
        <div className="pb__total_left">Total</div>
        <div className="pb__total_right">
          <span>100'000</span>TAK
        </div>
      </div>
      <div className="price__box_bottom">
        <BlueBtn text="CONNECT WALLET" style={{ width: "100%" }} />
      </div>
    </div>
  );
};
