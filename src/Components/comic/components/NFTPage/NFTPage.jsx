  ...
  return (
    <div className="nft__page">
      <div className="nft__page_header">
        ...
        <div className="nft__page_desc">
          Owning a page, or even better, a full comic book, will allow you to
          receive special surprises, bonuses, and rewards!
        </div>
        <div className="nft__page_menu">
          <div
            className={`nft__page_menuitem ${
              activeBox1 == "1" && "active__menu_item"
            }`}
            onClick={() => {
              setActiveBox1("1");
            }}
          ...
          <div
            className={`nft__page_menuitem ${
              activeBox1 == "2" && "active__menu_item"
            }`}
            onClick={() => {
              setActiveBox1("2");
            }}
          ...
          <div
            className={`nft__page_menuitem ${
              activeBox1 == "3" && "active__menu_item"
            }`}
            onClick={() => {
              setActiveBox1("3");
            }}
          ...
          <div
            className={`nft__page_menuitem ${
              activeBox1 == "4" && "active__menu_item"
            }`}
            onClick={() => {
              setActiveBox1("4");
            }}
      ...
      <LightBox>
        ...
        {activeBox1 === "1" && (
          <div className="nftp__box1">
            <div className="nft__page_subheading">
              In order to purchase a comic book page,
              <br />
              you’ll need to own at least 1 Mooning Monkey.
            </div>
            <div className="nft__page_innerbox">
              <LightBox>
                <div className="nftp__innerbox_content">
                  Select Page To Buy:Page &nbsp;
                  <span
                    className="nftp__innerbox_dropdown"
                    onClick={() => setDropdown(!dropdown)}
                  >
                    {dropdown && (
                      <div className="dropdown__items_wrap">
                        {dropItems.map((item, index) => {
                          return (
                            <div
                              ...
                              style={{
                                background:
                                  item === activeDropdown ? "#f832ec" : "black",
                              }}
                              onClick={(e) => setActiveDropdown(item)}
                            >
                              {item}
                            </div>
                          );
                    ...
                    <img
                      src={ArrowDown}
                      className="nftp__innerbox_dropicon"
                    />{" "}
                  </span>
                  &nbsp; of Part {activeDropdown}{" "}
                </div>
              </LightBox>
            </div>
            ...
            <div className="nftp__box_containers">
              <div className="nftp__box_left">
                ...
                <div className="nftp__left_bottom">
                  A maximum of 1 page per wallet can be purchased.
                  <br />
                  <span>ONLY $TAK TOKEN WILL BE ACCEPTED</span>
                </div>
              </div>
            ...
            <div className="nftp__bottom_wrapper">
              ...
              <div className="nftp__bottom_text">
                The Final $TAK amount will be updated 12 hours before the mining
                event and will correspond to $1000 per Page
              </div>
            </div>
          </div>
        )}
        {activeBox1 !== "1" && (
          <div className="nftp__box2">
            <div className="nftp__box2_text">
